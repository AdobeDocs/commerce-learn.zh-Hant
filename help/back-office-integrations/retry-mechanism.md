---
title: 使用重試機制的原生功能
description: 針對彈性應用程式運用Adobe I/O Events的重試機制，包括重試條件和視覺指示器。
landing-page-description: 瞭解並運用Adobe I/O Events的內建重試機制，以增強應用程式復原力並有效管理事件啟用。
kt: 15872
doc-type: video
duration: 314
audience: all
...
# 運用Adobe I/O Events重試機制提高應用程式彈性
