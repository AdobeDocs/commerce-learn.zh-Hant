...
description: 瞭解如何管理Adobe Commerce Optimizer執行個體 — 更新名稱和說明，並找出GraphQL、目錄URL和執行個體ID等關鍵端點。
...
* [Adobe Commerce Optimizer概觀](https://experienceleague.adobe.com/en/docs/commerce-learn/adobe-commerce-optimizer/overview){target="_blank"}
