...
* 剛開始使用Adobe Commerce但使用Adobe App Builder經驗有限的開發人員，他們正瞭解`web-src`資料夾及其內容。

## 視訊內容

* `web-src`資料夾的主要用途為何？
* 通常包含檔案和資料夾
* 如何在範例應用程式中使用`web-src`資料夾及其內容
...
在以下範例中，程式碼範例是限制請求的`not`。 若要避免400錯誤，請使用`searchCriteria`來縮小回應大小。
