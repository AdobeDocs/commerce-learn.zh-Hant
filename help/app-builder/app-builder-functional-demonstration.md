...
若要進一步瞭解如何搭配App Builder使用Adobe Commerce，請觀看以下影片，其中說明如何將Adobe Commerce連結至Amazon Seller Central。 此示範會使用App Builder所使用的Adobe Commerce事件，實現與Amazon Marketplace的持續整合。 本功能示範將說明此整合的運作方式，並探索Adobe App Builder的潛力。
