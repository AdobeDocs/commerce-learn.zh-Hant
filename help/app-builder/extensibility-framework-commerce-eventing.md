---
title: 擴充性框架和商務事件
description: 瞭解Adobe Developer App Builder擴充性架構、其主要功能，以及Commerce事件如何實現與Adobe Commerce的即時整合。
jira: KT-11740
doc-type: Tutorial
duration: 228
...
本功能展示說明App Builder及其在Adobe Commerce的潛在應用。 本影片介紹擴充性架構、主要客戶優勢和功能。
