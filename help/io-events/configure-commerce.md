...
瞭解如何設定Adobe Commerce以公開事件。 在[安裝適用於Adobe Commerce的Adobe I/O Events](https://developer.adobe.com/commerce/extensibility/events/installation){target="_blank"}找到其他檔案。
...
* 在Commerce管理員中設定Adobe I/O Events
* 在Commerce管理員中儲存私密金鑰
