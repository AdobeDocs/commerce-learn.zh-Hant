---
title: 全域傳遞模型
description: Adobe Commerce是一個平台，具有AI驅動的功能、強大的API和頂級安全性，可在AWS和Azure上取得，並提供彈性的支援選項。
...
Adobe Commerce是AWS和Azure提供的混合雲端電子商務平台，提供購物車、結帳和詳細目錄管理等核心功能。 它採用AI導向的服務，例如即時搜尋和產品推薦，並提供安全、可擴充的基礎架構以及廣泛的API支援。 此平台包含API Mesh和App Builder等開發人員工具，並提供兩個託管選項：雲端上的Commerce和Adobe Commerce Managed Services，兩者都確保高安全性和合規性標準。
...
* 可擴充且安全的基礎架構。  瞭解AWS和Azure上完全備援的多雲端基礎結構，以透過高安全性和合規性標準，確保最佳化的效能、彈性和彈性擴充性。
...
>[!VIDEO](https://video.tv.adobe.com/v/3433511?captions=chi_hant&learn=on)
