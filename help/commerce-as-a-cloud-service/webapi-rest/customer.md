...
* 以程式設計方式使用POST和PUT請求，搭配適當的JSON負載，建立及更新客戶帳戶

>[!VIDEO](https://video.tv.adobe.com/v/3479373?captions=chi_hant&learn=on)
...
>[!NOTE]
>
>確定您是在正確的組織內工作。 您的組織選擇會影響可在Experience Cloud和Developer Console中看到的例項和環境。
